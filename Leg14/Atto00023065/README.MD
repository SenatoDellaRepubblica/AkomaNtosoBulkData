## 14a Legislatura - Atto Senato n. 3500 ##

(README_ENG.MD for the English version)

* Scheda del Disegno di Legge sul sito del Senato:
	* Url: http://www.senato.it/leg/14/BGT/Schede/Ddliter/23065.htm
...
* Riferimenti al sito OpenData Senato http://dati.senato.it/:
	...
	* Query SPARQL per i documenti relativi all'Atto Senato:
		...
		{  
		    ?ddl a osr:Ddl.  
		    ?ddl osr:numFase 3500 .  
		    OPTIONAL { ?ddl osr:testoPresentato ?testoPresentato }  
		    OPTIONAL { ?ddl osr:testoApprovato ?testoApprovato }  
		}		
		```
* Contenuto dell'Atto nei Bulk Data su GitHub:
    * Url: https://github.com/SenatoDellaRepubblica/AkomaNtosoBulkData/tree/master/Leg14/Atto00023065		